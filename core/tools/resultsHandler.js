...
const resultsHandler = {
  ...
  prepareCsvRow (data, config) {
    ...
    let resultRow = {
      ...
      'Run date': moment().utc().format('lll'),
      'Start date': moment(performanceReport.startTime).format('YYYY-MM-DD HH:mm'),
      'End date': moment(performanceReport.endTime).format('YYYY-MM-DD HH:mm'),
